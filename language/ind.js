exports.wait = () => {
	return`*「 CARREGANDO 」 AGUARDE UM POUCO MANO TÔ PROCESSANDO*`
}
...
exports.noregis = () => {
	return`*「 NÃO REGISTRADO 」*\n\n*𝐕𝐎𝐂𝐄 𝐏𝐑𝐄𝐂𝐈𝐒𝐀 𝐒𝐄 𝐂𝐀𝐃𝐑𝐀𝐒𝐓𝐑𝐀𝐑 𝐏𝐀𝐑𝐀 𝐔𝐒𝐀𝐑 𝐎𝐒 𝐂𝐎𝐌𝐀𝐍𝐃𝐎𝐒 \n*exemplo: daftar (seu nome e tamanho do pau ou dos peitos e não esqueca desse bagulho--> | ) ex: ${prefix}daftar hideki|17*`
}
...
exports.limitend = (pushname) => {
	return`*Desculpe ${pushname} O limite de tts de hoje expirou. O limite é redefinido a cada hora 24:00.*`
}
